...
const db = getDatabase(firebaseApp, "https://adminportal-f55de-default-rtdb.asia-southeast1.firebasedatabase.app");
...
app.post("/upload", upload.single("image"), async (req, res) => {
  try {
    ...
    // Basic validation
    if (!req.file || !name || !category || ((category === "executive" && !role) || ((category === "students" || category === "web") && !year))) {
    ...
    res.json({
      ...
      member: { id: newMemberRef.key, ...encryptedData }
    });
